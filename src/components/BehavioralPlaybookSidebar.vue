<template>
  <aside class="behavioral-playbook-sidebar">
    ...
    <div class="social-links">
      <a
        href="https://medium.com/@techmade"
        target="_blank"
      ...
      <a
        href="https://www.instagram.com/techmadeco/"
        target="_blank"
        rel="noopener noreferrer"
        class="social-link"
...
.behavioral-playbook-sidebar {
  width: 320px;
  background: linear-gradient(180deg, #1a1a1e 0%, #18181b 50%, #161619 100%);
...
.behavioral-playbook-sidebar::before {
  content: "";
  position: absolute;
  top: 0;
  left: 0;
...
.sidebar-header::after {
  ...
  width: 60px;
  height: 2px;
  background: linear-gradient(90deg, #dcee77 0%, #c4d66a 100%);
  border-radius: 1px;
}
...
.section-link.active {
  color: #dcee77;
  font-weight: 600;
  background: rgba(220, 238, 119, 0.15);
}
...
.section-number {
  ...
  flex-shrink: 0;
  margin-top: 4px;
  box-shadow: 0 4px 12px rgba(220, 238, 119, 0.3);
  position: relative;
}
...
.subsection-link:hover {
  color: #ffffff;
  background: rgba(220, 238, 119, 0.08);
...
.subsection-link:hover::before {
  ...
  box-shadow: 0 0 8px rgba(220, 238, 119, 0.5);
}

.subsection-link.active {
  color: #dcee77;
  font-weight: 500;
  background: rgba(220, 238, 119, 0.12);
}

.subsection-link.active::before {
  opacity: 1;
  background: #dcee77;
  box-shadow: 0 0 12px rgba(220, 238, 119, 0.6);
}

.sidebar-footer {
  margin-top: 32px;
  padding-top: 20px;
  border-top: 1px solid rgba(220, 238, 119, 0.2);
  position: relative;
}
...
.back-to-interviews {
  ...
  border: 1px solid rgba(220, 238, 119, 0.1);
}

.back-to-interviews:hover {
  color: #ffffff;
  background: rgba(220, 238, 119, 0.15);
  border-color: rgba(220, 238, 119, 0.3);
  transform: translateY(-2px);
  box-shadow: 0 4px 12px rgba(220, 238, 119, 0.2);
}
...
.social-link:hover {
  ...
  box-shadow: 0 8px 20px rgba(220, 238, 119, 0.3);
}
