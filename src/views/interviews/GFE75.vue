      ...
      <div class="interview-main">
        <div class="container">
          <div class="page-header">
            <h1>GFE 75</h1>
            <p>
              Most important 75 questions for front-end interviews. The smallest
              list of practice questions that gets you the most mileage in your
              preparation.
            </p>
...
const filteredQuestions = computed(() => {
  return questions.value.filter((question) => {
    const categoryMatch =
      ...
      question.category.toLowerCase().includes(selectedCategory.value);
    const difficultyMatch =
      selectedDifficulty.value === "all" ||
      question.difficulty.toLowerCase() === selectedDifficulty.value;
