        ...
        <section class="questions-header">
          <div class="container">
            <div class="header-content">
              ...
              <p>
                Master front-end development through hands-on coding challenges.
                From JavaScript fundamentals to advanced React patterns.
              </p>
...
const questions = ref([
  {
    ...
    description:
      "Build a complete todo list with add, edit, delete, and toggle functionality. Include local storage persistence.",
    difficulty: "Easy",
  ...
  },
  {
    ...
    description:
      "Implement a React hook that delays updating a value until after a specified delay has passed.",
    difficulty: "Medium",
  ...
  },
  {
    ...
    description:
      "Create a typeahead component with keyboard navigation, highlighting, and API integration.",
    difficulty: "Hard",
  ...
  },
  {
    ...
    description:
      "Build an interactive star rating component with hover effects and accessibility features.",
    difficulty: "Easy",
  ...
  },
  {
    ...
    description:
      "Implement a virtualized list that efficiently renders large datasets with smooth scrolling.",
    difficulty: "Hard",
  ...
  },
  {
    ...
    description:
      "Create a collapsible accordion component with smooth animations and keyboard support.",
    difficulty: "Medium",
